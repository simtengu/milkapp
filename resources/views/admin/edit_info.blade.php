...
<div class="container">
    <div class="row justify-content-around mt-2 mt-md-4 p-3">
        <div style="box-shadow: 1px 1px 2px grey" class="col-md-5 card p-2 bg-app ">
          <h3 class="text-dark text-times first-level-title font-weight-bold text-capitalize">Taarifa kuhusu maziwa fresh</h3>
        ...
        <form method="POST" action="{{ route('save_fresh_bottle_details') }}" class="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input name="capacity" id="bottle_capacity" type="text" class="form-control" required>
                </div>
    
                <div class="form-group">
                    <label for="bottle_capacity">Bei husika</label>
                    <input name="price" id="bottle_capacity" type="number" class="form-control" required>
                </div>
 ...
 <div class="py-3">     
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tr>
                    ...
                    <div class="text-right">       
                        <button type="button" data-toggle="modal" data-target="#chupaFreshMilkForm" class="btn btn-success btn-sm pull-right"><i class="fas fa-plus"></i></button>
                    </div>
                   </th>
                </tr>
                </thead>
           ...
           <tr>
               <form method="POST" action="{{ route('edit_fresh_bottle_details',$bottle->id) }}" class="form">
                   @method('PATCH')
                   @csrf
               <td><input name="capacity" id="editFormInput" value={{ $bottle->capacity }} type="text"  required /></td>
               <td><input name="price" id="editFormInput" value={{$bottle->price }} type="number" required  /></td>  
               <td>
               <div class="d-flex justify-content-around">
                   <button type="submit" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button>
               </form>
                <form id="delete_fresh_bottle_form" method="POST" action="{{ route('delete_fresh_bottle',$bottle->id) }}"> 
                    @csrf
                    @method('DELETE')
                      <button onclick=" if( !confirm('unathibitisha kufuta taarifa hii')){
                    event.preventDefault(); }" type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                </form>
               </div>  
               </td>
           </tr>
  ...
  <hr>
          <div class="">     
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tr>
                    ...
                    <th>
                        <div class="text-right">
                            <button type="button" data-toggle="modal" data-target="#litaFreshMilkForm" class="btn btn-success btn-sm pull-right"><i class="fas fa-plus"></i></button>
                        </div>
                    </th>
                </tr>
                </thead>
           ...
           <tr>
               <form method="POST" action="{{ route('edit_fresh_volume_details',$volume->id) }}" class="form">
                   @method('PATCH')
                   @csrf
               <td><input name="volume" id="editFormInput" value={{ $volume->volume }} type="text"  required /></td>
               <td><input name="price" id="editFormInput" value={{$volume->price }} type="number" required  /></td>  
               <td>
               <div class="d-flex justify-content-around">
                   <button type="submit" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button>
               </form>
                <form id="delete_fresh_volume_form" method="POST" action="{{ route('delete_fresh_volume',$volume->id) }}"> 
                    @csrf
                    @method('DELETE')
                      <button onclick=" if( !confirm('unathibitisha kufuta taarifa hii')){
                    event.preventDefault(); }" type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
      ...
      {{-- taarifa juu ya maziwa mgando section............................................... --}}
        <div style="box-shadow: 1px 1px 2px grey" class="col-md-5 card bg-app ">
          <h3 class="text-dark text-times first-level-title font-weight-bold text-capitalize">Taarifa kuhusu maziwa mgando</h3>
        ...
        <form method="POST" action="{{ route('save_mgando_bottle_details') }}" class="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input name="capacity" id="mgando_bottle_capacity" type="text" class="form-control" required>
                </div>
    
                <div class="form-group">
                    <label for="bottle_capacity">Bei husika</label>
                    <input name="price" id="mgando_bottle_capacity" type="number" class="form-control" required>
                </div>
                <button type="submit" class="btn btn-app">submit</button>
            </div>
        </form>
          ...
          <div class="py-3">     
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tr>
                    ...
                    <th>
                        <div class="text-right">
                            <button type="button" data-toggle="modal" data-target="#chupaMgandoMilkForm" class="btn btn-success btn-sm pull-right"><i class="fas fa-plus"></i></button>
                        </div>
                    </th>
                </tr>
                </thead>
           ...
           <tr>
               <form method="POST" action="{{ route('edit_mgando_bottle_details',$bottle->id) }}" class="form">
                   @method('PATCH')
                   @csrf
               <td><input name="capacity" id="editFormInput" value={{ $bottle->capacity }} type="text"  required /></td>
               <td><input name="price" id="editFormInput" value={{$bottle->price }} type="number" required  /></td>  
               ...
               <div class="d-flex justify-content-around">
                ...
                <form id="delete_fresh_bottle_form" method="POST" action="{{ route('delete_mgando_bottle',$bottle->id) }}"> 
                    @csrf
                    @method('DELETE')
                      <button onclick=" if( !confirm('unathibitisha kufuta taarifa hii')){
                    event.preventDefault(); }" type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
        ...
        <div class="">     
            ...
            <table class="table table-dark table-striped table-hover">
                ...
                <tr>
                    ...
                    <th>
                        <div class="text-right">
                            <button type="button" data-toggle="modal" data-target="#litaMgandoMilkForm" class="btn btn-success btn-sm pull-right"><i class="fas fa-plus"></i></button>
                        </div>
                    </th>
                </tr>
                </thead>
           ...
           <tr>
               ...
               <div class="d-flex justify-content-around">
                ...
                <form id="delete_mgando_volume_form" method="POST" action="{{ route('delete_mgando_volume',$volume->id) }}"> 
                    @csrf
                    @method('DELETE')
                      <button onclick=" if( !confirm('unathibitisha kufuta taarifa hii')){
                    event.preventDefault(); }" type="submit" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
