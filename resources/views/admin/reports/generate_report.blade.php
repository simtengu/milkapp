        ...
        <div class="card my-4">
            <div class="card-header">
                ...
                <div class="d-flex flex-wrap">
                    <div>
                        <a href="{{ route('print.general.report') }}" class="btn btn-sm btn-outline-secondary mx-1">Today</a>
                    </div>
                   <div style="position: relative">
                       ...
                       <div style="display:none; position: absolute;left:0px;top:31px;z-index:100;" class="border rounded shadow bg-light" id="date_div">
                         ...
                         <div class="p-2">
                             <form method="POST" action="{{ route('print.date.report') }}" class="form">
                                @csrf
                   ...
                   <div style="position: relative">
                       ...
                       <div style="display:none; position: absolute;left:0px;top:31px;z-index:100;" class="border rounded shadow bg-light" id="date_range_div">
                         ...
                         <div class="p-2">
                             <form method="POST" action="{{ route('print.date_range.report') }}" class="form">
                                 @csrf
                                    <div class="form-group">
                  ...
                  <div>
                      <a href="{{ route('print.all.report') }}" class="btn btn-sm btn-outline-secondary mx-1">All</a>
                 </div> 
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="7" class="text-app text-center"> hakuna taarifa</td>
                                        </tr>
                                    @endif
